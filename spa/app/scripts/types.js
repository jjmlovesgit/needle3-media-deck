 ...
 * @typedef {{id:string, catalogId?:string|null, title:string, kind:MediaKind, reason:string, file:File|string, source?:'shared', relativePath?:string, artist?:string, album?:string, albumKey?:string, track?:number|null, year?:number|null, aliases?:string[], durationMs?:number|null, metadataSource?:string, modified?:number}} MediaItem
